...
class Ui_Faculty(object):
    ...
    def facultylogin(self):
        try:
            ...
            self.ui1 = Ui_FacultyHome(self.fachome)
...
#         self.label_4.setStyleSheet("image: url(../Attendance/images/teachers.png);")
#         self.label_4.setText("")
#         self.label_4.setObjectName("label_4")
#         self.register_2 = QtWidgets.QLabel(Dialog)
#         self.register_2.setGeometry(QtCore.QRect(470, 330, 121, 51))
#         self.register_2.setStyleSheet("image: url(../Attendance/images/regg.png);")
